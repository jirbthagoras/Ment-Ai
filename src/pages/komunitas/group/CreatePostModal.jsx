    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-2xl w-full max-w-2xl overflow-hidden shadow-xl transform"
        >
          {/* Modal Header */}
          <div className="bg-gradient-to-r from-[#4B7BE5] to-[#1E498E] px-6 py-4 flex justify-between items-center">
